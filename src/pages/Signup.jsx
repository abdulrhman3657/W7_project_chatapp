...
function Signup() {
  ...
  // check if user exists, (username and email must be unique)
  ...
  return (
    <div className="">
      <div className="flex min-h-full flex-col justify-center px-6 py-6 lg:px-8 bg-linear-65">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <h2 className=" text-center text-2xl/9 font-bold tracking-tight text-gray-900">Sign up</h2>
        </div>
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm p-4 bg-gray-300 rounded-2xl">
